AFRAME.registerComponent('playDrums', {
    schema: {},
    init : function() {
        const Context_AF = this;
        Context_AF.soundElem = document.querySelector('#drum-loop');
        ...
        Context_AF.el.addEventListener('click', function(event) {
            ...
            Context_AF.soundElem.components['playDrumLoop'].stopSound(); //stop first so we aren't trying to play more than once at same time
            Context_AF.soundElem.components['playDrumLoop'].playSound();
        });
    },
